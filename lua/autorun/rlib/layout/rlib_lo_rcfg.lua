...
function PANEL:Init( )
    ...
    */
    ...
    self.p_content              = ui.new( 'pnl', self.p_sub         )
    :static                     ( FILL                              )
    :margin                     ( 0, 0, 0, 0                        )
    :padding                    ( 3                                 )
    ...
    */
    ...
    self.dsp                    = ui.new( 'rlib.ui.scrollpanel', self.p_content )
    :static                     ( FILL                              )
    :margin                     ( 35, 30, 5, 0                      )
        ...
        */
        ...
        :tall                       ( 28                                )
                                    ...
                                    :draw( function( s, w, h )
                                       ...
                                       design.title_boxcat( m_name:upper( ), pref( 'rcfg_item_name' ), m_ver, pref( 'rcfg_item_ver' ), clr_title, clr_ver_box, clr_ver_txt, 8, 13, 1, 1 )
                                    end )
    ...
    */
    ...
    :tall                           ( 25                                )
                                    ...
                                    :draw( function( s, w, h )
                                        design.box( 0, 0, w, h, Color( 30, 30, 30, 255 ) )
                                        draw.SimpleText( str_modules, pref( 'rcfg_footer_i' ), w - 6, h / 2, Color( 150, 150, 150, 255 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER )
                                    end )
